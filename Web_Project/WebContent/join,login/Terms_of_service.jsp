		...
		<div class="wrapper real">
			...
			<!-- 1 -->
				<div class="row gtr-uniform">
					<div class="check col-6 col-12">
						<input type="checkbox" id="demo-checkbox-beta1" name="check" class="check">
						<label for="demo-checkbox-beta1">[필수] 이용약관 동의, 개인정보 수집 및 이용 동의</label>
						<br>
					</div>
				</div>
				<div class="boxes row gtr-200">
					<div class="col-6 col-12">
					<textarea name="demo-textarea" id="demo-textarea" rows="4" readonly style="resize: none;">여러분을 환영합니다.
...
네이버 서비스와 관련하여 궁금하신 사항이 있으시면 고객센터(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.
			...
			<!-- 2 -->
				<div class="row gtr-uniform">
					<div class="check col-6 col-12-medium">
						<input type="checkbox" id="demo-checkbox-beta2" name="check" class="check">
						<label for="demo-checkbox-beta2">[선택] 개인정보 수집 밒 이용 동의, 마케팅 정보 이메일 수실 동의, 마케팅 정보 SMS 수신 동의</label>
						<br>
					</div>
				</div>
				<div class="boxes row gtr-200">
...
네이버 서비스와 관련하여 궁금하신 사항이 있으시면 고객센터(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.
				...
				<br>
				<ins id="guide" style="color: red;">*필수 항목을 체크하지 않을시 자동으로 전체 동의를 한것으로 간주합니다.</ins>
				<!-- <div class="row gtr-uniform">
					<div class="col-6 col-12-small">
						<input type="checkbox" id="demo-checkbox-alpha" class="check" name="check"  onclick='selectAll(this)'>
						<label for="demo-checkbox-alpha">전체 동의&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
					</div>
				</div> -->
			<!-- submit -->
				<br><br>
			<ul class="actions fit">
				<li><a href="${pageContext.request.contextPath}/index.jsp" class="button fit">취 소</a></li>
				<li><a href="javascript:true_btn();" class="button primary fit">확 인</a></li>
			</ul>
			</div>
		</div>
	</div>
	...
	<!-- Scripts -->
			...
			<script src="${pageContext.request.contextPath}//code.jquery.com/jquery-3.3.1.min.js"></script>
    		<script>
/*	     		전체동의 버튼 누를 시 
				...
				function true_btn(){
					var checkbox1 = document.getElementById("demo-checkbox-beta1");
					const checkbox2 = document.getElementById("demo-checkbox-beta2");
					if(!checkbox1.checked){
						checkbox1.checked = true;
						checkbox2.checked = true;
					}
						location.href = "${pageContext.request.contextPath}/join.me";
						return false;
				}
			</script>
</html>