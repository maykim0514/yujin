...
<body>
	<c:set var="draftmail" value="${requestScope.draftmail}" />
		...
		<form action="${pageContext.request.contextPath}/mail/MailWriteOk.ma" method="post" name="mailcontentForm">
			<div class="row gtr-uniform">
				<div class="col-6 col-12-xsmall">
					...
					<input name="mailnum" id="checkval" type="hidden" value="${draftmail.getMailnum()}"/>
					<br>
					받는 사람<input type="text" name="targetid" id="targetid" onkeyup="checkID()" value="${draftmail.getTargetid()}" placeholder="아이디를 입력하세요.">
					<span style="color:red;" id="checkID"></span>
					<div id="space"><br></div>
					<textarea name="mailcontent" id="content" rows="10" cols="40">${draftmail.getMailcontent()}</textarea>
